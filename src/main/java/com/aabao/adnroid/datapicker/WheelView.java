...
package com.aabao.adnroid.datapicker;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			/**
			 * ANTI_ALIAS_FLAG 抗锯齿
			 * Paint.FAKE_BOLD_TEXT_FLAG 设置粗体
			 */
...
//		Log.i(TAG, " WheelView onDraw");
	...
	private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            Log.i(TAG, "   onScroll distanceX = "+distanceX +"  distanceY = "+distanceY +"  e1 = "+e1.getY()+"  e2 = "+e2.getY());
			startScrolling();
